...
public class Admin_chat_list extends Fragment implements MessageAdapter.ItemClickListener, MessageAdapter.ItemLongClickListener{
    ...
    public Admin_chat_list(int userid,int style, int otherID){
        this.userid = userid;
        this.style = style;
