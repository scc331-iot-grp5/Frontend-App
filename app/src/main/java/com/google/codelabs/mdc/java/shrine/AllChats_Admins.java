...
public class AllChats_Admins extends Fragment implements MessagesView.ItemClickListener, MessagesView.ItemLongClickListener, OnItemSelectedListener{
    ...
    public AllChats_Admins(int userid,int style)
    {
        this.userid = userid;
        this.style = style;
        this.x = this;
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(R.layout.all_chats_admin, container, false);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((NavigationHost) getActivity()).navigateTo(new Admin_chat_list(userid, style, selectedID), false); // Navigate to the next Fragment
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        ((NavigationHost) getActivity()).navigateTo(new Admin_chat_list(userid,style,adapter.getID(position)), false); // Navigate to the next Fragment
