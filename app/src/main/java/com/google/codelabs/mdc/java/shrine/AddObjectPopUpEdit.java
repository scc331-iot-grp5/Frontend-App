...
public class AddObjectPopUpEdit{
    ...
    /*
        change mDate to of object type ( name and id)
        pass in id of object
        display data of that id
        update type in db with new name and colour
     */


    public void showPopupWindow(final View view, Context context, int id) {
